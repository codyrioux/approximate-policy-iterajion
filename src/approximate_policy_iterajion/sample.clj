...
(defn create-api-policy
  ...
  (api/api m reward dp sp 0.99 (partial api/policy features reward sp m) trajectory-count trajectory-length features 2 "sample" :kernel-type (:rbf api/kernel-types)))
